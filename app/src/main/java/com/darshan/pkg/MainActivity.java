...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonSub = (Button) findViewById(R.id.btsub);
        buttonMul = (Button) findViewById(R.id.btmul);
        buttonDivision = (Button) findViewById(R.id.btdiv);
        buttonC = (Button) findViewById(R.id.btc);
        buttonEqual = (Button) findViewById(R.id.btequl);
